...
let url = "";
export default class ElementarySchoolDashboard extends Component {
    ...
    componentDidMount() {
        ...
        url = require('../assets/all_links').SAT_elementary_school;
        this.setState({urlGrade: url});
        dispatchCustomEvent({type: 'titleChange', data: {title: 'SAT School Dashboard - Elementary'}});
    }
