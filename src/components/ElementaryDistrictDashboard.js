...
let url = "";
export default class ElementaryDistrictDashboard extends Component {
    ...
    componentDidMount() {
        ...
        url = require('../assets/all_links').SAT_elementary_district;
        this.setState({urlGrade: url});
        dispatchCustomEvent({type: 'titleChange', data: {title: 'SAT District Dashboard - Elementary'}});
    }
