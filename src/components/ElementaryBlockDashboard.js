...
let url = "";
export default class ElementaryBlockDashboard extends Component {
    state = {
        urlGrade: ``,
        blocks: [],
        districts: [],
    ...
    componentDidMount() {
        ...
        url = require('../assets/all_links').SAT_elementary_block;
        this.setState({urlGrade: url});
        dispatchCustomEvent({type: 'titleChange', data: {title: 'SAT Block Dashboard - Elementary'}});
    }
