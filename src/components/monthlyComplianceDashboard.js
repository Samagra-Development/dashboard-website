...
let months = [];
export default class MonthlyComplianceDashboard extends Component {
    state = {
        allData: [],
        districts: [],
        designations: ['Diet Mentor', 'ARP', 'S.R. G'],
        blocks: [],
        nyayPanchayats: [],
    ...
    onSelectDesignation = designation => {
        ReactGA.event({
            category: 'Designation Filter Change',
    ...
    componentDidMount() {
        ...
        dispatchCustomEvent({type: 'titleChange', data: {title: 'Compliance Dashboard'}});
    ...
    getUrlToLoad = () => {
        ...
        if (this.state.selectedDesignation) {
            result += "designation=" + this.state.selectedDesignation;
        }
        return result;
    }
                    ...
                    <Grid container spacing={24}>
                        ...
                        <Grid item xs>
                            <SimpleDropdown
                                ...
                                onSelect={this.onSelectDesignation}
                            />
                        </Grid>
                    </Grid>
                </div>
