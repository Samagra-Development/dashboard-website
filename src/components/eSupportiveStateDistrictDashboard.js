...
export default class ESupportiveStateDistrictDashboard extends Component {
    state = {
        urlGrade: `${url}`,
        urlLO: `${url}`,
        years: [],
    ...
    download() {
        const urls = [
            {name:'years',url:'https://dashboard.mp.samagra.io/api/public/dashboard/aa8bd7c7-f977-442a-805e-0595becffb54/params/8a86750f/values'},
            {name:'months',url:'https://dashboard.mp.samagra.io/api/public/dashboard/aa8bd7c7-f977-442a-805e-0595becffb54/params/e30e9ef7/values'},
            {name:'districts',url:'https://dashboard.mp.samagra.io/api/public/dashboard/aa8bd7c7-f977-442a-805e-0595becffb54/params/1236885c/values'},
        ]
        let ctr = 0;
    ...
    componentDidMount() {
        ...
        if (typeof window !== "undefined" && window.location.href.indexOf("/e-supportive/") > -1) {
            url = require('../assets/all_links').e_supportive_state_district_dashboard;
            this.setState({
                urlGrade: url,
                urlLO: url
            });
            dispatchCustomEvent({type: 'titleChange', data: {title: 'E-Supportive Supervision Dashboard: State and District Officers'}});
        } else {
